    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            { 
                ...
                {
                    string Message = (response as Error).ErrorMessage;
                ...
                else
                {
                    ...
                    identity.AddClaim(new Claim("Email", model.Username));
                    identity.AddClaim(new Claim("UserId", adminModel.Id.ToString()));
                    identity.AddClaim(new Claim("FullName", adminModel.FullName));
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            try
            {
                ...
                var response = await ApiCall.CallApi("api/User/Register", User, model);
