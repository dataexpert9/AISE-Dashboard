...
namespace BasketWebPanel.Areas.Dashboard.Controllers
{
    ...
    public class AdminController : Controller
    {
        ...
        public ActionResult Index(int? AdminId)
        {
            ...
            if (AdminId.HasValue)
            {
                var responseAdmin = AsyncHelpers.RunSync<JObject>(() => ApiCall.CallApi("api/GetEntityById", User, null, true, false, null, "EntityType=" + (int)EntityTypes.Admin, "Id=" + AdminId.Value));
        ...
        public JsonResult DeleteAdmin(int AdminId)
        {
            try
            {
                var response = AsyncHelpers.RunSync<JObject>(() => ApiCall.CallApi("api/Admin/DeleteEntity", User, null, true, false, null, "EntityType=" + (int)EntityTypes.Admin, "Id=" + AdminId));
                if (response is Error)
